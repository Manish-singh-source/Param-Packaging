...
<head>
  ...
  <link rel="stylesheet" href="assets/css/static-param.css?v=15">
</head>
<body>
  <div class="header">
    <section id="header" class="appear">
      <div class="navbar navbar-fixed-top" role="navigation">
        <div class="container">
          <div class="row">
            <div class="col-sm-4"><a class="navbar-brand" href="/"><img src="assets/theme/img/logo.jpg" alt="Print Pack"></a></div>
            ...
            <div class="col-sm-4"><a class="navbar-brand pull-right" href="/"><img src="assets/theme/img/logo-param.jpg" alt="Param"></a></div>
          </div>
          <div class="clear"></div>
        </div>
        ...
        <div class="navbar-collapse collapse" id="primary-menu">
          <ul class="nav navbar-nav skrollable skrollable-after">
            <li class="<?php echo $active === 'home' ? 'active' : ''; ?>"><a href="/#index">Home</a></li>
            <li class="<?php echo $active === 'who' ? 'active' : ''; ?>"><a href="/#whoweare">Who We Are</a></li>
            <li class="<?php echo $active === 'what' ? 'active' : ''; ?>"><a href="/#whatwedo">What We Do</a></li>
            <li><a href="/#industry">Industry Verticals</a></li>
            <li><a href="/#services">Our Clients</a></li>
